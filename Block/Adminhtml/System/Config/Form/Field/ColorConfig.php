...
class ColorConfig extends Field
{
    ...
    {
        $fieldSelectorAttr = \Commersys\AnnouncementBar\Block\Adminhtml\System\Config\Form\Field\Color::FIELD_SELECTOR_ATTRIBUTE;
                    ...
                    jQuery(function($) {
                        ...
                        var initSpectrum = function($field) {
                            ...
                            $field.spectrum({
                                ...
                                , cancelText: "Cancel"
                                , chooseText: "Apply"
                                , localStorageKey: "commersys.base.color"
